...
public class Test {
	...
	public static void main(String[] args) {
		...
		while (continueOn == true) {
			...
			System.out
					.println("To return the name of the best customer, press 2.");
			...
			if (choice == 0) {
				...
				while (nextCustomer == true) {
					...
					System.out
							.println("Do you want to enter another customer? 1 for yes, 2 for no.");
				...
				System.out
						.println("Do you want to do another action? 1 for yes, 2 for no.");
				choice = scan.nextInt();
				if (choice == 1) {
					continueOn = true;
				} else {
